...
| `gap` | `keyof FleetTheme['spacing'] \| number` | No | `3` | 헤더 내부 요소 간 세로 간격 |
| `padding` | `keyof FleetTheme['spacing'] \| number` | No | `0` | 헤더/본문 공통 수평 패딩 |
| `contentSpacing` | `keyof FleetTheme['spacing'] \| number` | No | `5` | 헤더-본문 간격 및 본문 top padding |
